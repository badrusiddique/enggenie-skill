...
Follow the guide for the AI coding tool you use:

| Platform | Guide | Install Difficulty |
|----------|-------|--------------------|
| **Claude Code** (recommended) | [claude-code.md](claude-code.md) | One command |
| **Cursor IDE** | [cursor.md](cursor.md) | Copy directory |
| **GitHub Copilot CLI** | [copilot-cli.md](copilot-cli.md) | Plugin system |
| **Google Gemini CLI** | [gemini-cli.md](gemini-cli.md) | Extension config |
| **OpenCode.ai** | [opencode.md](opencode.md) | Plugin system |
...
- [Full skill reference](../../README.md)
- [Examples](../examples/)
- [Guides](../guides/)
- [Repository](https://github.com/badrusiddique/enggenie-skill)
